...
print("\033[0;91mThis Tool's Free By Shahinur Rahman ")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Shahinur Rahman'

    print '\033[0;94mFACEBOOK : Cyber Shahin'

    print '\033[0;96mGITHUB   : cyber shahin'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Shahin-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[Shahin-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
